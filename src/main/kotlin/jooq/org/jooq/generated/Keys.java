...
public class Keys {
    ...
    public static final ForeignKey<EspeciallyDangerousOperationsRecord, UserSystemRecord> ESPECIALLY_DANGEROUS_OPERATIONS__FK_EMPLOYEE_OOR = Internal.createForeignKey(EspeciallyDangerousOperations.ESPECIALLY_DANGEROUS_OPERATIONS, DSL.name("fk_employee_oor"), new TableField[] { EspeciallyDangerousOperations.ESPECIALLY_DANGEROUS_OPERATIONS.EMPLOYEE_ID }, Keys.USER_SYSTEM_PKEY, new TableField[] { UserSystem.USER_SYSTEM.ID }, true);
